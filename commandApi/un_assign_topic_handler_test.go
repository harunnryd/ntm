...
var _ = Describe("UnAssignTopicHandler", func() {
	var (
		h error
		e *echo.Echo
		c echo.Context
	...
	Context("when i call NewUnAssignTopicHandler", func() {
		BeforeEach(func() {
			e = echo.New()
			req = httptest.NewRequest(echo.PATCH, "/", strings.NewReader(`
				{
					"topic_id": "bda8923e-9a29-4756-858e-978dfe01920b"
				}`))
